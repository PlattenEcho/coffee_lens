...
class UploadResep extends StatefulWidget {
  const UploadResep({super.key});

  @override
  State<UploadResep> createState() => _UploadResepState();
}

class _UploadResepState extends State<UploadResep> {
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: kWhiteColor,
                    hintStyle: regularTextStyle.copyWith(color: kGreyColor),
                    focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: kPrimaryColor),
                    ),
                    enabledBorder: UnderlineInputBorder(
                ...
                TabBar(
                  ...
                  unselectedLabelStyle: blackTextStyle.copyWith(fontSize: 16),
                  tabs: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextForm(
                                        ...
                                        maxLines: 4,
                                        hintText: "Tulis penjelasan langkah"),
                                  ],
                                ),
                              );
                            }).toList(),
